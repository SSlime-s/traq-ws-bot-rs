...
impl FileInfo {
    /// ファイル情報
    pub fn new(id: uuid::Uuid, name: String, mime: String, size: i64, md5: String, is_animated_image: bool, created_at: String, thumbnails: Vec<crate::models::ThumbnailInfo>, thumbnail: Option<crate::models::FileInfoThumbnail>, channel_id: Option<uuid::Uuid>, uploader_id: Option<uuid::Uuid>) -> FileInfo {
        FileInfo {
            id,
            name,
            mime,
