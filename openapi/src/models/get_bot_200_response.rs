...
impl GetBot200Response {
    pub fn new(id: uuid::Uuid, bot_user_id: uuid::Uuid, description: String, developer_id: uuid::Uuid, subscribe_events: Vec<String>, mode: crate::models::BotMode, state: crate::models::BotState, created_at: String, updated_at: String, tokens: crate::models::BotTokens, endpoint: String, privileged: bool, channels: Vec<uuid::Uuid>) -> GetBot200Response {
        GetBot200Response {
            id,
            bot_user_id,
            description,
