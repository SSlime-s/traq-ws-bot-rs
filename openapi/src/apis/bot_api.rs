...
pub async fn activate_bot(configuration: &configuration::Configuration, bot_id: &str) -> Result<(), Error<ActivateBotError>> {
    ...
    let local_var_uri_str = format!("{}/bots/{botId}/actions/activate", local_var_configuration.base_path, botId=crate::apis::urlencode(bot_id));
...
pub async fn change_bot_icon(configuration: &configuration::Configuration, bot_id: &str, _file: std::path::PathBuf) -> Result<(), Error<ChangeBotIconError>> {
    ...
    let local_var_uri_str = format!("{}/bots/{botId}/icon", local_var_configuration.base_path, botId=crate::apis::urlencode(bot_id));
...
pub async fn delete_bot(configuration: &configuration::Configuration, bot_id: &str) -> Result<(), Error<DeleteBotError>> {
    ...
    let local_var_uri_str = format!("{}/bots/{botId}", local_var_configuration.base_path, botId=crate::apis::urlencode(bot_id));
...
pub async fn get_bot(configuration: &configuration::Configuration, bot_id: &str, detail: Option<bool>) -> Result<crate::models::GetBot200Response, Error<GetBotError>> {
    let local_var_configuration = configuration;
...
pub async fn get_bot_logs(configuration: &configuration::Configuration, bot_id: &str, limit: Option<i32>, offset: Option<i32>) -> Result<Vec<crate::models::BotEventLog>, Error<GetBotLogsError>> {
    ...
    let local_var_uri_str = format!("{}/bots/{botId}/logs", local_var_configuration.base_path, botId=crate::apis::urlencode(bot_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn get_channel_bots(configuration: &configuration::Configuration, channel_id: &str) -> Result<Vec<crate::models::BotUser>, Error<GetChannelBotsError>> {
    ...
    let local_var_uri_str = format!("{}/channels/{channelId}/bots", local_var_configuration.base_path, channelId=crate::apis::urlencode(channel_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn inactivate_bot(configuration: &configuration::Configuration, bot_id: &str) -> Result<(), Error<InactivateBotError>> {
    ...
    let local_var_uri_str = format!("{}/bots/{botId}/actions/inactivate", local_var_configuration.base_path, botId=crate::apis::urlencode(bot_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn let_bot_join_channel(configuration: &configuration::Configuration, bot_id: &str, post_bot_action_join_request: Option<crate::models::PostBotActionJoinRequest>) -> Result<(), Error<LetBotJoinChannelError>> {
    ...
    let local_var_uri_str = format!("{}/bots/{botId}/actions/join", local_var_configuration.base_path, botId=crate::apis::urlencode(bot_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn let_bot_leave_channel(configuration: &configuration::Configuration, bot_id: &str, post_bot_action_leave_request: Option<crate::models::PostBotActionLeaveRequest>) -> Result<(), Error<LetBotLeaveChannelError>> {
    ...
    let local_var_uri_str = format!("{}/bots/{botId}/actions/leave", local_var_configuration.base_path, botId=crate::apis::urlencode(bot_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn reissue_bot(configuration: &configuration::Configuration, bot_id: &str) -> Result<crate::models::BotTokens, Error<ReissueBotError>> {
    ...
    let local_var_uri_str = format!("{}/bots/{botId}/actions/reissue", local_var_configuration.base_path, botId=crate::apis::urlencode(bot_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
