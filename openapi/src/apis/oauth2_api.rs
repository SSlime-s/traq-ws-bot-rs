...
pub async fn delete_client(configuration: &configuration::Configuration, client_id: &str) -> Result<(), Error<DeleteClientError>> {
    ...
    let local_var_uri_str = format!("{}/clients/{clientId}", local_var_configuration.base_path, clientId=crate::apis::urlencode(client_id));
...
pub async fn get_client(configuration: &configuration::Configuration, client_id: &str, detail: Option<bool>) -> Result<crate::models::GetClient200Response, Error<GetClientError>> {
    let local_var_configuration = configuration;
...
/// OAuth2 認可エンドポイント
pub async fn get_o_auth2_authorize(configuration: &configuration::Configuration, client_id: &str, response_type: Option<crate::models::OAuth2ResponseType>, redirect_uri: Option<&str>, scope: Option<&str>, state: Option<&str>, code_challenge: Option<&str>, code_challenge_method: Option<&str>, nonce: Option<&str>, prompt: Option<crate::models::OAuth2Prompt>) -> Result<(), Error<GetOAuth2AuthorizeError>> {
    let local_var_configuration = configuration;
...
/// OAuth2 認可エンドポイント
pub async fn post_o_auth2_authorize(configuration: &configuration::Configuration, client_id: &str, response_type: Option<crate::models::OAuth2ResponseType>, redirect_uri: Option<&str>, scope: Option<&str>, state: Option<&str>, code_challenge: Option<&str>, code_challenge_method: Option<&str>, nonce: Option<&str>, prompt: Option<crate::models::OAuth2Prompt>) -> Result<(), Error<PostOAuth2AuthorizeError>> {
    let local_var_configuration = configuration;
