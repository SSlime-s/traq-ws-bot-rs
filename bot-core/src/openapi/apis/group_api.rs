...
pub async fn add_user_group_admin(configuration: &configuration::Configuration, group_id: &str, post_user_group_admin_request: Option<crate::openapi::models::PostUserGroupAdminRequest>) -> Result<(), Error<AddUserGroupAdminError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/groups/{groupId}/admins", local_var_configuration.base_path, groupId=crate::openapi::apis::urlencode(group_id));
...
pub async fn add_user_group_member(configuration: &configuration::Configuration, group_id: &str, user_group_member: Option<crate::openapi::models::UserGroupMember>) -> Result<(), Error<AddUserGroupMemberError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/groups/{groupId}/members", local_var_configuration.base_path, groupId=crate::openapi::apis::urlencode(group_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn change_user_group_icon(configuration: &configuration::Configuration, group_id: &str, _file: std::path::PathBuf) -> Result<(), Error<ChangeUserGroupIconError>> {
    ...
    let local_var_uri_str = format!("{}/groups/{groupId}/icon", local_var_configuration.base_path, groupId=crate::openapi::apis::urlencode(group_id));
...
pub async fn create_user_group(configuration: &configuration::Configuration, post_user_group_request: Option<crate::openapi::models::PostUserGroupRequest>) -> Result<crate::openapi::models::UserGroup, Error<CreateUserGroupError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_user_group(configuration: &configuration::Configuration, group_id: &str) -> Result<(), Error<DeleteUserGroupError>> {
    ...
    let local_var_uri_str = format!("{}/groups/{groupId}", local_var_configuration.base_path, groupId=crate::openapi::apis::urlencode(group_id));
...
pub async fn edit_user_group(configuration: &configuration::Configuration, group_id: &str, patch_user_group_request: Option<crate::openapi::models::PatchUserGroupRequest>) -> Result<(), Error<EditUserGroupError>> {
    let local_var_configuration = configuration;
...
pub async fn edit_user_group_member(configuration: &configuration::Configuration, group_id: &str, user_id: &str, patch_group_member_request: Option<crate::openapi::models::PatchGroupMemberRequest>) -> Result<(), Error<EditUserGroupMemberError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/groups/{groupId}/members/{userId}", local_var_configuration.base_path, groupId=crate::openapi::apis::urlencode(group_id), userId=crate::openapi::apis::urlencode(user_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::PATCH, local_var_uri_str.as_str());
...
pub async fn get_user_group(configuration: &configuration::Configuration, group_id: &str) -> Result<crate::openapi::models::UserGroup, Error<GetUserGroupError>> {
    let local_var_configuration = configuration;
...
pub async fn get_user_group_members(configuration: &configuration::Configuration, group_id: &str) -> Result<Vec<crate::openapi::models::UserGroupMember>, Error<GetUserGroupMembersError>> {
    let local_var_configuration = configuration;
...
/// ユーザーグループのリストを取得します。
pub async fn get_user_groups(configuration: &configuration::Configuration, ) -> Result<Vec<crate::openapi::models::UserGroup>, Error<GetUserGroupsError>> {
    let local_var_configuration = configuration;
...
pub async fn remove_user_group_admin(configuration: &configuration::Configuration, group_id: &str, user_id: &str) -> Result<(), Error<RemoveUserGroupAdminError>> {
    ...
    let local_var_uri_str = format!("{}/groups/{groupId}/admins/{userId}", local_var_configuration.base_path, groupId=crate::openapi::apis::urlencode(group_id), userId=crate::openapi::apis::urlencode(user_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
