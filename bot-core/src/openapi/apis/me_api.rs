...
pub async fn add_my_star(configuration: &configuration::Configuration, post_star_request: Option<crate::openapi::models::PostStarRequest>) -> Result<(), Error<AddMyStarError>> {
...
/// 自分に新しくタグを追加します。
pub async fn add_my_user_tag(configuration: &configuration::Configuration, post_user_tag_request: Option<crate::openapi::models::PostUserTagRequest>) -> Result<crate::openapi::models::UserTag, Error<AddMyUserTagError>> {
    let local_var_configuration = configuration;
...
pub async fn change_my_notify_citation(configuration: &configuration::Configuration, put_notify_citation_request: Option<crate::openapi::models::PutNotifyCitationRequest>) -> Result<(), Error<ChangeMyNotifyCitationError>> {
    let local_var_configuration = configuration;
...
/// 自身のパスワードを変更します。
pub async fn change_my_password(configuration: &configuration::Configuration, put_my_password_request: Option<crate::openapi::models::PutMyPasswordRequest>) -> Result<(), Error<ChangeMyPasswordError>> {
    let local_var_configuration = configuration;
...
/// 自身のユーザー情報を変更します。
pub async fn edit_me(configuration: &configuration::Configuration, patch_me_request: Option<crate::openapi::models::PatchMeRequest>) -> Result<(), Error<EditMeError>> {
    let local_var_configuration = configuration;
...
/// 自分の指定したタグの状態を変更します。
pub async fn edit_my_user_tag(configuration: &configuration::Configuration, tag_id: &str, patch_user_tag_request: Option<crate::openapi::models::PatchUserTagRequest>) -> Result<(), Error<EditMyUserTagError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/users/me/tags/{tagId}", local_var_configuration.base_path, tagId=crate::openapi::apis::urlencode(tag_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::PATCH, local_var_uri_str.as_str());
...
/// 自身のユーザー詳細情報を取得します。
pub async fn get_me(configuration: &configuration::Configuration, ) -> Result<crate::openapi::models::MyUserDetail, Error<GetMeError>> {
    let local_var_configuration = configuration;
...
pub async fn get_my_external_accounts(configuration: &configuration::Configuration, ) -> Result<Vec<crate::openapi::models::ExternalProviderUser>, Error<GetMyExternalAccountsError>> {
    let local_var_configuration = configuration;
...
/// メッセージ引用通知の設定情報を変更します。
pub async fn get_my_notify_citation(configuration: &configuration::Configuration, ) -> Result<crate::openapi::models::GetNotifyCitation, Error<GetMyNotifyCitationError>> {
    let local_var_configuration = configuration;
...
pub async fn get_my_sessions(configuration: &configuration::Configuration, ) -> Result<Vec<crate::openapi::models::LoginSession>, Error<GetMySessionsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_my_user_tags(configuration: &configuration::Configuration, ) -> Result<Vec<crate::openapi::models::UserTag>, Error<GetMyUserTagsError>> {
    let local_var_configuration = configuration;
...
/// ユーザー設定を取得します。
pub async fn get_user_settings(configuration: &configuration::Configuration, ) -> Result<crate::openapi::models::UserSettings, Error<GetUserSettingsError>> {
    let local_var_configuration = configuration;
...
pub async fn link_external_account(configuration: &configuration::Configuration, post_link_external_account: Option<crate::openapi::models::PostLinkExternalAccount>) -> Result<(), Error<LinkExternalAccountError>> {
    let local_var_configuration = configuration;
...
pub async fn remove_my_star(configuration: &configuration::Configuration, channel_id: &str) -> Result<(), Error<RemoveMyStarError>> {
    ...
    let local_var_uri_str = format!("{}/users/me/stars/{channelId}", local_var_configuration.base_path, channelId=crate::openapi::apis::urlencode(channel_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
...
pub async fn revoke_my_session(configuration: &configuration::Configuration, session_id: &str) -> Result<(), Error<RevokeMySessionError>> {
    ...
    let local_var_uri_str = format!("{}/users/me/sessions/{sessionId}", local_var_configuration.base_path, sessionId=crate::openapi::apis::urlencode(session_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
...
pub async fn unlink_external_account(configuration: &configuration::Configuration, post_unlink_external_account: Option<crate::openapi::models::PostUnlinkExternalAccount>) -> Result<(), Error<UnlinkExternalAccountError>> {
    let local_var_configuration = configuration;
