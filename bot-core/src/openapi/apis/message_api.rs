...
pub async fn create_pin(configuration: &configuration::Configuration, message_id: &str) -> Result<crate::openapi::models::MessagePin, Error<CreatePinError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/messages/{messageId}/pin", local_var_configuration.base_path, messageId=crate::openapi::apis::urlencode(message_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn delete_message(configuration: &configuration::Configuration, message_id: &str) -> Result<(), Error<DeleteMessageError>> {
    ...
    let local_var_uri_str = format!("{}/messages/{messageId}", local_var_configuration.base_path, messageId=crate::openapi::apis::urlencode(message_id));
...
pub async fn edit_message(configuration: &configuration::Configuration, message_id: &str, post_message_request: Option<crate::openapi::models::PostMessageRequest>) -> Result<(), Error<EditMessageError>> {
    let local_var_configuration = configuration;
...
/// 指定したメッセージを取得します。
pub async fn get_message(configuration: &configuration::Configuration, message_id: &str) -> Result<crate::openapi::models::Message, Error<GetMessageError>> {
    let local_var_configuration = configuration;
...
pub async fn get_pin(configuration: &configuration::Configuration, message_id: &str) -> Result<crate::openapi::models::MessagePin, Error<GetPinError>> {
    let local_var_configuration = configuration;
...
/// メッセージを検索します。
pub async fn search_messages(configuration: &configuration::Configuration, word: Option<&str>, after: Option<String>, before: Option<String>, r#in: Option<&str>, to: Option<&str>, from: Option<&str>, citation: Option<&str>, bot: Option<bool>, has_url: Option<bool>, has_attachments: Option<bool>, has_image: Option<bool>, has_video: Option<bool>, has_audio: Option<bool>, limit: Option<i32>, offset: Option<i32>, sort: Option<&str>) -> Result<crate::openapi::models::MessageSearchResult, Error<SearchMessagesError>> {
    let local_var_configuration = configuration;
